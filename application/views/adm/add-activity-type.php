...
<html>
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Form Add Activity Type</h4>
                        ...
                        <div class="row">
                            ...
                            <div id="msg"></div>
                                <div class="card-box">
                                    ...
                                    <form action="javascript:add();" id="form-add" method="post">
                                        <div class="form-group">
                                            <label for="userName">Activity Name<span class="text-danger">*</span></label>
                                            <input type="text" name="activity_name" required placeholder="Enter Activity Name" class="form-control" id="activity_name">
                                        </div>
        ...
        <script type="text/javascript">
            ...
            {
                $.ajax({
                    url:"<?php echo base_url() ?>adm/Activity_type/add_data",
                    type:"POST",
                    dataType:"JSON",
