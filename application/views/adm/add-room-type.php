...
<html>
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Form Add Room Type</h4>
                                ...
                                <div class="card-box">
                                    ...
                                    <form action="javascript:add();" id="form-add" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="room_type_name" required placeholder="Enter Room type Name" class="form-control" id="room_type_name">
                                        </div>
        ...
        <script type="text/javascript">
            ...
            {
                $.ajax({
                    url:"<?php echo base_url() ?>adm/Room/add_data_type",
                    type:"POST",
                    dataType:"JSON",
