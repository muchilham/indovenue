...
<html>
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Form Add Room Area</h4>
                                ...
                                <div class="card-box">
                                    ...
                                    <form action="javascript:add();" id="form-add" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="room_area_name" required placeholder="Enter Room Area Name" class="form-control" id="room_area_name">
                                        </div>
        ...
        <script type="text/javascript">
            ...
            {
                $.ajax({
                    url:"<?php echo base_url() ?>adm/Room/add_data_area",
                    type:"POST",
                    dataType:"JSON",
