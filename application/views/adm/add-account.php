                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Form Add Account</h4>
                        ...
                        <div class="row">
                            ...
                            <div id="msg"><?php echo $this->session->flashdata('notif'); ?></div>
                                <div class="card-box">
                                    <h4 class="header-title m-t-0">Form Add</h4>
                                    <p class="text-muted font-14 m-b-20">
                                    </p>

                                    <form action="<?php echo base_url() ?>adm/Account/add_data" id="form-add" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="userName">User Name<span class="text-danger">*</span></label>
                                            <input type="text" name="account_username" required placeholder="Enter username" class="form-control" id="username">
                                        </div>
                                        <div class="form-group">
                                            <label for="emailAddress">Email address<span class="text-danger">*</span></label>
                                            <input type="email" required placeholder="Enter email" name="account_email" class="form-control" id="emailAddress">
                                        </div>
                                        <div class="form-group">
                                            <label for="pass1">Password<span class="text-danger">*</span></label>
                                            <input id="pass1" type="password" name="account_password" placeholder="Password" required class="form-control">
                                        </div>
                                        <div class="form-group">
