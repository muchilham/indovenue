                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <h1>Selamat Kata sandi akun anda sudah diperbarui.</h1>
<br>
Silahkan anda login kembali menggunakan password dibawah ini.&nbsp;
                        </td>
                    </tr>
                </tbody></table>
				<!--[if mso]>
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="mcnTextContentContainer" style="border-collapse: separate !important;border-radius: 3px;">
                    <tbody>
                        <tr>
                            <td align="left" valign="center" class="" style="font-family: Arial; font-size: 16px;">
                                Password baru anda adalah :<b>
                            </td>
                        </tr><tr>
                            <td align="center" valign="center" class="" style="font-family: Arial; font-size: 24px; padding: 15px;">
                                    <h1 style="display: inline;font-size: 32px"><?php echo $account_password; ?></h1></b>
                            </td>
                        </tr>
                    </tbody>
                </table>
